...
import { SubmitPLSForm } from "../submit-pls/submit-pls";
  ...
  return (
    <div>
      ...
      <div className="flex items-center py-4">
        ...
        <Button onClick={() => downloadToExcel()} className="ml-4" variant='outline'>
          Export to Excel <FaRegFileExcel  className="ml-2"/>
        </Button>
        <DropdownMenu>
          <DropdownMenuTrigger>
