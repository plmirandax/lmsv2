...
export const VerifyEmailEmailTemplate: React.FC<Readonly<VerifyEmailEmailTemplateProps>> = ({ email, emailVerificationToken }) => {
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:25px;padding-top:22px;width:100%;">
                                                                    <div class="alignment" align="center" style="line-height:10px">
                                                                        <div style="max-width: 640px;"><img src="https://264ed2eba1.imgdist.com/pub/bfra/u0rm7lkf/f03/i5a/zbb/RDRDC-BLACK-LOGO.png" style="display: block; height: auto; border: 0; width: 100%;" width="640" alt="I'm an image" title="I'm an image"></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
    ...
    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://rdrdc-prod.vercel.app/verify-email?token=${emailVerificationToken}" style="height:62px;width:222px;v-text-anchor:middle;" arcsize="97%" stroke="false" fillcolor="#1aa19c">
    <w:anchorlock/>
    <v:textbox inset="0px,0px,0px,0px">
    <center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px">
    <![endif]--><a href="https://rdrdc-prod.vercel.app/verify-email?token=${emailVerificationToken}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#1aa19c;border-radius:60px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:30px;padding-right:30px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="margin: 0; word-break: break-word; line-height: 32px;"><strong>Confirm Your Email</strong></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad" style="padding-top:40px;width:100%;">
                                                                    <div class="alignment" align="center" style="line-height:10px">
                                                                        <div style="max-width: 640px;"><img src="https://264ed2eba1.imgdist.com/pub/bfra/u0rm7lkf/qf5/him/0vo/RDRDC-WHITE-LOGO.png" style="display: block; height: auto; border: 0; width: 100%;" width="640" alt="Alternate text" title="Alternate text"></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
