                        ...
                        <div className="flex justify-between space-x-4">
                          <Avatar>
                            ...
                            <AvatarFallback className="bg-primary">
                              {ticket.Tenant?.name.slice(0, 2).toUpperCase()}
                            </AvatarFallback>
                          </Avatar>
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center pt-2">
                              ...
                              <span className="text-xs text-muted-foreground">
                                Joined{' '}
                                {ticket.Tenant?.createdAt.toLocaleDateString()}
                              </span>
                            </div>
                          </div>
                        </div>
                  ...
                  <CardFooter className="m-0 p-2 border-t-[1px] border-muted-foreground/20 flex items-center justify-between">
                    <div className="flex item-center gap-2">
                      <Avatar className="w-8 h-8">
                        <AvatarImage
                          alt="contact"
                          src={ticket.AssignedsysUser?.image || ''}
                        />
                        <AvatarFallback className="bg-primary text-sm text-white">
                          {ticket.AssignedsysUser?.name}
                          {!ticket.AssignedsysUserId && <User2 size={14} />}
                        </AvatarFallback>
                      </Avatar>
                      <div className="flex flex-col justify-center">
                        <span className="text-sm text-muted-foreground">
                          {ticket.AssignedsysUserId
                            ? 'Assigned to'
                            : 'Not Assigned'}
                        </span>
                        {ticket.AssignedsysUserId && (
